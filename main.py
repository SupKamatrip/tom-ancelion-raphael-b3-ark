...
url = ('http://api.openweathermap.org/data/2.5/weather?q='+weathercity+'&appid=9db93bdd1a0d2f47617d2c9158a903fa')
                                                                # je vous laisse prendre ma clé d'API si vous voulez
...
print(weatherprint.format(*pays, weathercity, convert, humidite, pression, ventsp, gps))